...
Num1:
    ...
    GOTO	Num2		    ;si el botón no está presionado va al 2
    GOTO	Alfa		    ;si el botón  está presionado va al a
...
Num2:
    ...
    CALL	Delay_250ms
    BTFSC	PORTA,3,0   ;PORTA <3> = 0  -  BUTTON PRESS
    GOTO	Num3		    ;si el botón no está presionado va al 3
    GOTO	Alfa
Num3:
    MOVLW	10110000B
    MOVWF	PORTD
    ...
    CALL	Delay_250ms
    BTFSC	PORTA,3,0   ;PORTA <3> = 0  -  BUTTON PRESS
    GOTO	Num4	    ;si el botón no está presionado va al 
    GOTO	Alfa
